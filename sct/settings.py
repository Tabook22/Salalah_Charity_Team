...
SECRET_KEY = '7-eoulp*k15d8vb4%rl=!(atw4s9l1t*)du-2q=j9k21)+r3w7'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['.herokuapp.com','https://salalahct.herokuapp.com','127.0.0.1','localhost']
...
STATIC_URL = '/static/'
# here we make a list of staticfiles within each applicaiton because in your different apps you my need to have different static files
STATICFILES_DIRS = [
    # This determines the locations where other static files are being pulled from. For
    os.path.join(BASE_DIR, 'sct/static'),
